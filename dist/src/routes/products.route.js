...
class ProductsRoute {
    ...
    initializeRoutes() {
        this.router.post(`${this.path}/`, (0, validation_middleware_1.default)(products_dto_1.CreateProductDto, 'body'), auth_middleware_1.default, this.productsController.createProduct);
        ...
        this.router.put(`${this.path}/:product_id`, (0, validation_middleware_1.default)(products_dto_1.UpdateProductDto, 'body'), auth_middleware_1.default, this.productsController.editProduct);
    }
}
