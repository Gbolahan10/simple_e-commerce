...
describe('AuthenticationController', () => {
  ...
  it('should handle the case where the user does not exist', async () => {
    ...
    expect(next).toHaveBeenCalledWith(new HttpException(409, 'User does not exist'));
});
...
it('should handle the case where the password is incorrect', async () => {
  ...
  beforeEach(() => {
    req = { body: { firstName: "firstname", lastName: "lastname", email: "test@gmail.com", password: "password", storeName: "teststore", storeDescription: "test desc", countryCode: "234", phoneNumber: "8023456789" }} as unknown as Request;
    jest.clearAllMocks();
  });
  ...
  it('should create a new user store - SIGN UP', async () => {
    ...
    expect(createMock).toHaveBeenCalledWith({ firstName: "firstname", lastName: "lastname", email: "test@gmail.com", password: 'hashedPassword', storeName: "teststore", storeDescription: "test desc", countryCode: "234", phoneNumber: "8023456789" });
